...
public class TimesheetController {
	...
	public void fromDate(ActionRequest request, ActionResponse response) {
		...
		Timesheet timeSheetFromDb = Beans.get(AbstractTimesheetRepository.class).all().order("-todate").fetchOne();
	...
	public void add(ActionRequest request, ActionResponse response) {
		...
		// "timesheet-grid");
		ActionViewBuilder avb = ActionView.define("Timesheet").model(Timesheet.class.getName()).add("form",
				"timesheet-form");
